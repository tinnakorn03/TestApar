...
declare const desc: import("ramda").CurriedFunction2<string, string | any[], (target: any, name: string, descriptor: PropertyDescriptor) => PropertyDescriptor>;
...
declare const params: import("ramda").CurriedFunction2<string, {
    [name: string]: any;
...
declare const Doc: {
    ...
    params: import("ramda").CurriedFunction2<string, {
        [name: string]: any;
    }, (target: any, name: string, descriptor: PropertyDescriptor) => PropertyDescriptor>;
    desc: import("ramda").CurriedFunction2<string, string | any[], (target: any, name: string, descriptor: PropertyDescriptor) => PropertyDescriptor>;
